...
| Branch     | Siege params   | Transaction rate | Concurrency | Longest transaction | Availability |
|------------|----------------|------------------|-------------|---------------------|--------------|
| django-2.6 | -d0 -r20 -c400 | 54.34 trans/sec  | 387.98      | 7.46                | 100.00%      |
| django-2.7 | -d0 -r20 -c400 | 61.88 trans/sec  | 390.34      | 10.55               | 100.00%      |

Увеличилось количество обрабатываемых транзакий в секунду, а также сократилось время самой длительной транзакции.